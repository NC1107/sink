//! Classic 5x7 fixed-width bitmap font (public domain, from the
//! Adafruit-GFX `glcdfont.c`). 256 glyphs, 5 column-bytes each;
//! bit N of a column byte is row N (top = bit 0).
//!
